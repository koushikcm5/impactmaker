...
export const siteData = {
  ...
  trust: {
    metrics: [
      { value: "50000+", label: "Corporates" },
      { value: "450+", label: "Seminars & Keynote Addresses" },
      { value: "4000+", label: "Educators" },
      { value: "70000+", label: "Students" },
      { value: "90+", label: "Education Institutes Visited" },
  ...
  educationFuture: {
    eyebrow: "Education Innovation",
    title: "Redefining Learning for the Future",
    summary: "A professional development philosophy for institutions ready to move beyond mechanical delivery and toward learning that is curious, practical, and lasting.",
    sections: [
      {
        label: "The Challenge",
        title: "Redefining Learning for the Future",
      ...
      {
        label: "The Shift",
        title: "Transforming Education Through Practical Innovation",
        icon: "Lightbulb",
        paragraphs: [
    ...
    highlights: [
      {
        ...
        description: "Help teams move past repetitive paperwork and process-heavy routines.",
        icon: "ClipboardCheck"
      },
      {
        title: "Restore Curiosity",
        description: "Create space for experimentation, risk-taking, and creative exploration.",
        icon: "Sparkles"
      },
      {
        title: "Build Practical Change",
        description: "Translate workshop learning into simple frameworks educators can use immediately.",
        icon: "Target"
      }
    ]
  },
  ...
  about: {
    title: "About Dr. Arun & J-Impact",
    intro: "Dr. Arun Divakaran is a seasoned and internationally experienced IT Professional, Executive Corporate Trainer and carries with him 19+ years of Rich Program & Digital Portfolio Management experience while working for Multi nationals such as Cognizant, UST Global, IQVIA. He is on his entrepreneurship journey as Co-Founder, AI Strategist & Executive Corporate Trainer @ J-Impact Creative Learning Services - A 360 degree Learning platform for creative transformation of Corporate Workforce, Student Learners and Educators. He has spearheaded and implemented more than 42 large scale projects across multiple geographic locations during his 11 Year stint at the USA. He is an ardent reader of books and has authored two best selling books listed in the article section of this page.",
    content: "",
    founder: {
  ...
  testimonials: [
    {
      ...
      designation: "Agile Workshop Attendee, Associate",
    ...
    },
    {
      ...
      designation: "Agile Workshop Attendee",
    ...
    },
    {
      ...
      designation: "SAFe Agile Workshop",
    ...
    },
    {
      ...
      author: "Mahima Singh",
      designation: "Student",
      image: "https://ui-avatars.com/api/?name=Mahima+Singh&background=1a1a2e&color=fff&size=128"
    },
    {
      ...
      designation: "Student",
      image: "https://ui-avatars.com/api/?name=Kumar+Bhargav&background=1a1a2e&color=fff&size=128"
    },
    {
    ...
    },
    {
      ...
      image: "https://ui-avatars.com/api/?name=K+Komala+Devi&background=1a1a2e&color=fff&size=128"
    },
    {
      ...
      image: "https://ui-avatars.com/api/?name=VA+Pravina&background=1a1a2e&color=fff&size=128"
    },
    {
      ...
      image: "https://ui-avatars.com/api/?name=Naveen+S&background=1a1a2e&color=fff&size=128"
    },
    {
      ...
      designation: "Student",
      image: "https://ui-avatars.com/api/?name=Kirtikaa+Chezhian&background=1a1a2e&color=fff&size=128"
    },
    {
    ...
    },
    {
      ...
      image: "https://ui-avatars.com/api/?name=Shivani&background=1a1a2e&color=fff&size=128"
    },
    {
      ...
      designation: "Associate, Technical Team Member",
      image: "https://ui-avatars.com/api/?name=Ramya+Saminathan&background=1a1a2e&color=fff&size=128"
    },
    {
    ...
    },
    {
      ...
      designation: "Workshop Attendee",
      image: "https://ui-avatars.com/api/?name=Course+Participant&background=1a1a2e&color=fff&size=128"
    },
    {
      text: "I am incredibly grateful for the opportunity to learn under Mr. Arun Divakaran. His depth of knowledge, passion for teaching, and genuine commitment to student success are truly inspiring. Every session was thoughtfully structured, making even the most complex topics clear and engaging. Beyond the technical expertise, Mr. Arun Divakaran consistently demonstrated patience, encouragement, and a true passion for seeing students thrive. I feel more confident and better equipped because of their guidance, and I wholeheartedly recommend Mr. Arun Divakaran to anyone seeking not just an instructor, but a true mentor. Thank you for making such a profound impact on my learning journey!",
      company: "Educational Program",
      author: "Student",
