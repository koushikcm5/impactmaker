...
const socialConfig = [
  ...
  { key: 'twitter',   label: 'X / Twitter', Icon: TwitterIcon, color: '#000000' },
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="footer-content">
          <div className="footer-section footer-brand">
            ...
            <p>Transforming education through creative teaching methods and innovative workshop experiences.</p>
